...
import com.pangreksa.service.model.enumerate.ContentTypeEnum;
import com.pangreksa.service.model.enumerate.DocumentTypeEnum;
import jakarta.persistence.*;
import lombok.*;

@Entity
@Table(name = "hr_document", schema = "public")
@Builder
@Getter
@Setter
@NoArgsConstructor
